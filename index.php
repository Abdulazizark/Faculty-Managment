...
<head>
	...
	<!-- icon -->
	<link rel="icon" href="images/AIT-logo.jpeg" >
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel" style="padding:20px 20px 20px 20px;">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img src="images/image1.jpeg" alt="Chania" width="460" height="200">
					</div>

					<div class="item">
						<img src="images/image2.gif" alt="Chania" width="460" height="200">
					</div>
